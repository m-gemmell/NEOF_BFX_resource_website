...
2. Hidden costs
3. They have ethical issues in terms of the ownership of people's works and IP
...
A big issue that is become more and more prevalent is the creation of data centres for AI.
These are incredibly expensive and destroy the environment.

## Hidden costs

Gen AI are incredibly expensive.
Companies have been massively subsidising the costs for users with the hope to increase their user base.
This cost may decrease but it is likely to increase.

This becomes a problem when someone becomes reliant of GenAI workflows and then the price suddenly increases for them.
The user then may not be able to afford to continue using GenAI and their workflows become useless meaning they have to spend an incredibly long time to create new workflows.
This issue is already happening as many companies are dramatically increasing the price for customers so the company does not lose billions of pounds on a tool that is incredibly expensive to run.
...
Additionally, bioinformatics information out there has high variation of quality from text books to forums and it is hard for humans, never mind AIs, to determine what is relevant and what is not.
